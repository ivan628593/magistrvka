/****************************************************************************
** Meta object code from reading C++ file 'diagnosticmodel.h'
**
...
#error "The header file 'diagnosticmodel.h' doesn't include <QObject>."
...
const QMetaObject DiagnosticModel::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_DiagnosticModel.data,
      qt_meta_data_DiagnosticModel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DiagnosticModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DiagnosticModel.stringdata0))
        return static_cast<void*>(const_cast< DiagnosticModel*>(this));
